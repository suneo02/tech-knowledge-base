...
项目使用 Git Subtree 管理嵌套的代码仓库，用于在 `private/carrier/` 相关材料中引用外部项目源码作为参考资料。

### 当前 Subtree 配置

- **路径**：`private/carrier/assets/gel-workspace`
...
```bash
git subtree push --prefix=private/carrier/assets/gel-workspace \
