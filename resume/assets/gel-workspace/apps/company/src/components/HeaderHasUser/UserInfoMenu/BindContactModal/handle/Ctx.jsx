 ...
 * 绑定手机号 或者 绑定邮箱 的ctc
 */
export const BindContactModalCtx = createContext({
  confirmLoading: false, // modal confirm btn loading

  form: null, // form instance
...
export const BindContactModalProvider = ({ children }) => {
  ...
  return <BindContactModalCtx.Provider value={{ ...state, dispatch }}>{children}</BindContactModalCtx.Provider>
}
