...
const IcLayoutEntriesChangeRecords: React.FC<{
  data: GetIntegratedCircuitLayoutDetailResponse['entriesChangeRecords']
}> = ({ data }) => {
  const columns: any = [
    {
      title: STRINGS.INDEX,
...
export default IcLayoutEntriesChangeRecords
