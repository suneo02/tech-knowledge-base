      ...
      <div className="rankingListDetail">
        <div className="pageTitle">
          <Breadcrumb>
            ...
            <Breadcrumb.Item>{rankingListInfo.directoryName}</Breadcrumb.Item>
          </Breadcrumb>
          <a
        ...
        <div className="main_content">
          ...
          >
            ...
            <Tabs activeKey={activeKey} onChange={this.tabChange}>
              <TabPane tab={this.$translation(138216)} key={'0'}>
              ...
              <TabPane tab={this.$translation(437762)} key={'3'}>
