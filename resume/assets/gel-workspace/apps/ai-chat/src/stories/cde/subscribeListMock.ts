...
export const subscribeListMock = [
  ...
  {
    id: '60279447387945858',
    subName: '小米 北京',
    subPush: true,
    superQueryLogic:
      '{"filters":[{"title":"企业名称","itemId":1,"logic":"any","itemField":"corp_name","value":["小米"]},{"title":"地区","itemId":89,"logic":"prefix","itemField":"area_code","value":["03030101"]}]}',
  },
  {
  ...
  {
    id: '60256887281597306',
    subName: 'rank',
    subPush: true,
    superQueryLogic:
      '{"filters":[{"field":"data_from","itemId":78,"logic":"any","title":"机构规模","value":["298010000,298020000,298040000"]},{"field":"govlevel","itemId":77,"logic":"any","title":"营业状态","value":["存续"]},{"itemId":138,"logic":"any","value":[{"objectName":"科技小巨人企业","objectId":"2010202479|108020113","certYear":1,"id":"2010202479|108020113","name":"科技小巨人企业","validDate":0,"selfDefine":0,"itemOption":[]},{"objectName":"高新技术企业","objectId":"2010202098|108020101","certYear":0,"id":"2010202098|108020101","name":"高新技术企业","validDate":1,"objectDate":"20250304-20250315"}],"title":"科技型企业名录","field":"corpListDetailQueryLogic"}]}',
  },
  {
...
export const monitorListMock: SuperListCdeMonitor[] = subscribeListMock.map((item) => {
  return {
    ...item,
