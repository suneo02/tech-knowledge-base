...
export const ERROR_TYPE = {
  DEFAULT: t('api:421457', '似乎遇到了点问题，请稍后再试。'),
  ErrorAbort: t('api:421477', '已按您要求停止回答。如有需要可随时重新提问。'),
  ErrorAudit: t(
    'api:421476',
    '根据有关政策法规要求，我无法回答此问题，请尝试换个问题。我是您的商业查询智能助手，我将竭尽全力为您提供有效信息。'
  ),
  ErrorFuse: t('api:421460', '今日提问已达上限，请明日再来。'),
  VersionError: t('', '当前无法同步，请刷新重试'),
  BizError: t('', '当前无法同步，请联系管理员'),
  OutOfLimit: t('', '当前表格已超限，请添加新表格'),
  InufficientPoints: t(
    'api:464127',
    '当前积分不足，本次操作需要 {{consumptionPoint}} 积分 ，可购买 SVIP 享受每日赠送 10,000 积分。'
  ),
}
/**
 * 问题状态码与错误文本的映射
