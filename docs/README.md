...
本知识库遵循统一的文档编写规范，详见 [文档编写规范](./meta/writing-guidelines.md)
...
- ✅ 建立统一的文档编写规范（见 [文档编写规范](./meta/writing-guidelines.md)）
- ✅ 统一命名约定（kebab-case）
...
| 编写规范 | [文档编写规范](./meta/writing-guidelines.md) | 文档标准 |
...
3. **使用文档模板**：参考 [文档编写规范](./meta/writing-guidelines.md) 中的模板
