export const mockSubscriptions = (length = 100) =>
  Array.from({ length }, (_, index) => ({
    id: index.toString(),
    subName: `Mock Subscription ${index + 1}`,
    subPush: false,
    superQueryLogic: JSON.stringify({ filters: [] }),
  }))

export const mockSubscriptionsWithFilters = {
  mail: 'su***0@outlook.com',
  records: [
    {
      id: '61722392683127907',
      subName: '小米和华为. ',
      subPush: false,
      superQueryLogic: '',
    },
    {
      id: '61722327742722339',
      subName: 'a3cd3',
      subPush: false,
      superQueryLogic:
        '{"filters":[{"field":"data_from","itemId":78,"logic":"any","title":"机构规模","value":["298010000,298020000,298040000"]},{"field":"govlevel","itemId":77,"logic":"any","title":"营业状态","value":["存续"]},{"itemId":1,"logic":"any","value":["小米华为"],"title":"企业名称","field":"corp_name"}]}',
    },
    {
      id: '61722234556821794',
      subName: '小米',
      subPush: false,
      superQueryLogic:
        '{"filters":[{"field":"data_from","itemId":78,"logic":"any","title":"机构规模","value":["298010000,298020000,298040000"]},{"field":"govlevel","itemId":77,"logic":"any","title":"营业状态","value":["存续"]}]}',
    },
    {
      id: '61653034451641441',
      subName: '房地产行业',
      subPush: false,
      superQueryLogic:
        '{"filters":[{"title":"行业","itemId":90,"logic":"prefix","field":"industry_code","value":["7411","7401"]}]}',
    },
    {
