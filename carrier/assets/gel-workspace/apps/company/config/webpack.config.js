...
// const otherPages = ['searchPatent', 'searchBrand', 'searchGlobal', 'searchGroup', 'searchFetured']
const otherPages = ['SearchHome', 'Company', 'SearchHomeList', 'BankingWorkbench']
  ...
  return {
    ...
    entry: isEnvDevelopment
      ...
      : {
          ...
          Company: paths.appCompanyIndexJs,
          SearchHomeList: paths.appSearchHomeListIndexJs,
          BankingWorkbench: paths.appbankWorkBenchIndexJs,
          SearchHome: paths.appHomeIndexJs,

          // searchBid: paths.appSearchBidIndexJs,
          // browser: paths.appBrowserIndexJs,
          // searchBrand: paths.appSearchBrandIndexJs,
          // searchPatent: paths.appSearchPatentIndexJs,
        },
    ...
    output: {
      ...
      publicPath: paths.publicUrlOrPath, //  注:cdn有一些问题，先不走cdn模式   'auto', //paths.publicUrlOrPath,
              ...
              options: {
                ...
                plugins: [
                  ...
                  [
                    'import',
                    {
                      libraryName: '@wind/chart-builder',
                      style: false,
                      camel2DashComponentName: false,
                    },
                    '@wind/chart-builder',
                  ],
                  //   ['import', { libraryName: 'echarts-for-react', style: false, camel2DashComponentName: false }, 'echarts-for-react'],
            ...
            // using the extension .module.css
            {
              ...
              use: getStyleLoaders({
                ...
                modules: {
                  ...
                  // 关键配置：将 .my-class-name => styles.myClassName
                  exportLocalsConvention: 'camelCase',
                  // 如果只想导出驼峰写法，去掉原始 - 写法，可以用 'camelCaseOnly'
