...
| 顺序调度   | 队列有剩余       | `progress.currentIndex`               | 串行触发 AI 请求并追踪 correlationId（详见 [Correlation ID 设计](./correlation-id-design.md)） | 进度条更新、当前章节高亮 |
...
- [Correlation ID 设计文档](./correlation-id-design.md) – 批量 correlationId 管理与追踪。
