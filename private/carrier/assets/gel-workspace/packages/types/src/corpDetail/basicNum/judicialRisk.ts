...
export interface CorpBasicNumJudicialRisk {
  ...
  frozenShareHoldingsCount: number //股权冻结-持有股份冻结总数
  frozenShareholderEquityCount: number //股权冻结-股东股份冻结总数
  travelRestrictionCount: number //限制出境总数
  bountyAnnouncementCount: number //悬赏公告总数
}
