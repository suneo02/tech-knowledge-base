...
const APPS_CONFIG = {
  company: {
    name: 'Company',
    buildCommand: 'app build company --staging',
  ...
  'ai-chat': {
    name: 'AI Chat',
    buildCommand: 'app build ai-chat --staging',
  ...
  'report-ai': {
    name: 'Report AI',
    buildCommand: 'app build report-ai --staging',
  ...
  'report-preview': {
    name: 'Report Preview',
    buildCommand: 'app build report-preview --staging',
  ...
  'report-print': {
    name: 'Report Print',
    buildCommand: 'app build report-print --staging',
  ...
  'wind-zx': {
    name: 'Wind ZX',
    buildCommand: 'app build wind-zx --staging',
