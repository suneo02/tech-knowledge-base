...
import { useRPOutlineXAgent } from '../../../hooks/RPOutline/useRPOutlineXAgent';
import { useReportConversationManager } from '../../../hooks/useRPConversationManager';
import { getApiPrefix, getWsid } from '../../../utils';
import { parseRPOutlineMessage } from '../parsers';
 ...
 *
 * 架构优化：
 * - 移动到 components/ChatRPOutline/hooks 避免循环依赖
 * - hook → parser → AIFooter → Context 单向依赖
 *
