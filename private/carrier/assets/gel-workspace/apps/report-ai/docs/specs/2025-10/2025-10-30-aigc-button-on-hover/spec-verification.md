...
| 测试类型 | 覆盖范围             | 工具         | 参考规范                                                  |
| -------- | -------------------- | ------------ | --------------------------------------------------------- |
| 单元测试 | Hook 逻辑、状态管理  | Vitest       | @see [测试规范](../../../../../docs/rule/code-testing-vitest-storybook-rule.md) |
| 组件测试 | 按钮渲染、样式、交互 | Vitest + RTL | @see [测试规范](../../../../../docs/rule/code-testing-vitest-storybook-rule.md) |
| 集成测试 | 完整流程、多实例隔离 | Vitest       | @see [测试规范](../../../../../docs/rule/code-testing-vitest-storybook-rule.md) |
| 视觉测试 | 主题适配、响应式布局 | Storybook    | @see [测试规范](../../../../../docs/rule/code-testing-vitest-storybook-rule.md) |
