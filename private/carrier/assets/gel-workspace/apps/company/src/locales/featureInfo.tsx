...
export default {
  ...
  2010202479: {
    ...
    brief: intl(
      '314136',
      '一般指在研究、开发、生产、销售和管理过程中，通过技术创新、管理创新、服务创新或模式创新取得核心竞争力，提供高新技术产品或服务，具有较高成长性或发展潜力的科技创新中小企业。'
    ),
  },
  2010202470: {
  ...
  2010100370: {
    ...
    brief: intl(
      '314138',
      '是由国家工业和信息化部组织遴选认定的，培育一批主营业务突出、竞争力强、成长性好的专精特新“小巨人”企业。'
    ),
  },
  2010202471: {
  ...
  2010200008: {
    ...
    brief: intl(
      '314087',
      '是党中央、国务院批准实施、面向农村经济主战场的指导性科技开发计划，是我国国民经济计划和科学技术计划的一个重要组成部分，是实施科教兴农的重要措施。'
    ),
  },
  2010200007: {
    ...
    brief: intl(
      '314140',
      '以国内外市场需求为导向，以国家、地方和行业的科技攻关计划、最新技术研究开发计划成果以及其它科研成果为依托，以发展高新技术产品、形成产业为目标，择优评选并组织实施的高科技产业化项目。通过火炬计划项目的实施，造就高新技术企业和企业集团。'
    ),
  },
  2010200013: {
    ...
    brief: intl(
      '314088',
      '是国家科技计划的重要组成部分，计划的主要任务是：以实现决策科学化、民主化为目标，综合运用自然科学、社会科学和工程技术多门类、多学科知识，为科技和经济社会发展的重大决策提供支撑。'
    ),
  },
  2010202481: {
    ...
    brief: intl(
      '314141',
      '以科技人员为主体创办的，实行自筹资金、自愿组合、自主经营、自负盈亏、自我约束、自我发展的经营机制，主要从事科技成果转化及技术开发、技术转让、技术咨询、技术服务或实行高新技术及其产品的研究、开发、生产、销售的智力、技术密集型的经济实体。'
    ),
  },
  2010202480: {
    ...
    brief: intl(
      '314142',
      '是指国家为了扶持高端技术性服务业的发展，对从事技术外包、业务外包和知识外包服务的企业进行税收等多项政策支持的企业类型。'
    ),
  },
  2010202474: {
  ...
  2010200009: {
    ...
    brief: intl(
      '314089',
      '是指运用现代科技知识、现代技术和分析研究方法，以及经验、信息等要素向社会提供智力服务的新兴产业，主要包括科学研究、专业技术服务、技术推广、科技信息交流、科技培训、技术咨询、技术孵化、技术市场、知识产权服务、科技评估和科技鉴证等服务。'
    ),
  },
  ...
  2010000078: {
    ...
    brief: intl(
      '437836',
      '是指因资金不足，经中国人民银行批准，自行发售债券，也可以委托银行或其他金融机构代理发售债券，筹集所需资金的企业。'
    ),
  },
  10000343: {
  ...
  2010202476: {
    ...
    brief: intl(
      '314091',
      '是指拥有自主知识产权和知名品牌，具有较强国际竞争力，依靠技术创新获取市场竞争优势和持续发展的企业。'
    ),
  },
  2010200011: {
    ...
    brief: intl(
      '314150',
      '是指产业链相关联企业、研发和服务机构在特定区域聚集，通过分工合作和协同创新，形成具有跨行业跨区域带动作用和国际竞争力的产业组织形态。'
    ),
  },
  2010202477: {
    ...
    brief: intl(
      '314151',
      '是指不为公众所熟知，却在某个细分行业或市场占据领先地位，拥有核心竞争力和明确战略，其产品、服务难以被超越和模仿的中小型企业。'
    ),
  },
  2010200014: {
    ...
    brief: intl(
      '314152',
      '国家重点新产品计划是国家科技计划体系中科技产业化环境建设的重要组成部分，是一项政策性引导计划。'
    ),
  },
  2010100686: {
  ...
  2010100369: {
    ...
    brief: intl(
      '314153',
      '是指长期专注于制造业某些特定细分产品市场，生产技术或工艺国际领先，单项产品市场占有率位居全球前列的企业。'
    ),
  },
  2010100371: {
  ...
  2010202472: {
    ...
    brief: intl(
      '314155',
      '是指软件企业的认定和软件产品的登记，认定标准2011年1月1日后依法在中国境内成立的企业法人。特点是软件产品实行登记和备案制度。'
    ),
  },
  ...
  2010100694: {
    ...
    brief: intl(
      '314173',
      '是指入选双高计划的院校。“双高计划”旨在打造技术技能人才培养高地和技术技能创新服务平台；引领职业教育服务国家战略、融入区域发展、促进产业升级。'
    ),
  },
  2010100697: {
    ...
    brief: intl(
      '314159',
      '是指中国共产党和中华人民共和国国务院在世纪之交为建设具有世界先进水平的一流大学而做出的重大决策。'
    ),
  },
  2010100698: {
