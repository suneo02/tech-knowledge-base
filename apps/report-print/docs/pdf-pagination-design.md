...
> - 返回: [README](./README.md)
> - 新版文档: 
>   - [PDF 分页架构设计](./pdf-pagination-architecture.md)
>   - [PDF 分页流程实现](./pdf-pagination-process.md)
> 
...
flowchart TD
    ...
    subgraph 极端行分割与后续
        I --> J[CellSplitter 返回 fitPart 和 remainingPart]
        J --> K[1. 将 fitPart 渲染到当前行\n2. (可选) 创建新页]
        K --> L[将 remainingPart 视作一个全新的行，放回待处理列表头部]
        L --> D
    end
