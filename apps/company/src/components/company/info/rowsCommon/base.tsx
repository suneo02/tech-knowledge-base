...
export const corpInfoNameRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoCreditCodeRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoBizRegNoRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  title: intl('138476', '注册号'),
  dataIndex: 'biz_reg_no',
}
export const corpInfoBussNoRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  ...corpInfoBizRegNoRow,
  title: window.en_access_config ? 'Company Code' : '企业编号',
}

// Row for "组织机构代码"
export const corpInfoOrgCodeRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoTypeRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
// Row for "纳税人识别号"
export const corpInfoTaxIdRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  title: intl('138539', '纳税人识别号'),
  dataIndex: 'taxIdNo',
}

export const corpInfoLegalPersonRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoTaxpayerQualificationRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  title: intl('437434', '纳税人资质'),
  dataIndex: 'taxQualiType',
}

export const corpInfoRegCapitalRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoPaidInCapitalRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoStartDateRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoOperPeriodBeginRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoOperPeriodEndRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoOperPeriodRangeRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  title: intl(207789, '证书有效期'),
  // dataIndex 可以不设，或只设为其中一个字段。但如果你需要排序筛选，需要与后端字段保持一致。
  dataIndex: 'oper_period_begin',
  render: (_, record) => {
    const { oper_period_begin, oper_period_end } = record
    const begin = oper_period_begin ? wftCommon.formatTime(oper_period_begin) : intl('367373', '日期不明')
    const end = oper_period_end ? wftCommon.formatTime(oper_period_end) : intl('271247', '无固定期限')
    // 如果都没有 日期不明
    if (!oper_period_begin && !oper_period_end) return intl('367373', '日期不明')
    return `${begin} ${window.en_access_config ? '~' : '至'} ${end}` // TODO 待优化
  },
}

export const corpInfoProvinceRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  title: intl('437319', '所属省份'),
  dataIndex: 'province',
}

export const corpInfoAreaRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  ...corpInfoProvinceRow,
  title: window.en_access_config ? intl('32674', '地区') : '国家/地区',
}

export const corpInfoRegAuthorityRow: HorizontalTableCol<ICorpBasicInfoFront> = {
  title: intl('138477', '登记机关'),
  dataIndex: 'reg_authority',
}

export const corpInfoOrgAuthorityRow: HorizontalTableCol<ICorpBasicInfoFront> = {
...
export const corpInfoIssueDateRow: HorizontalTableCol<ICorpBasicInfoFront> = {
