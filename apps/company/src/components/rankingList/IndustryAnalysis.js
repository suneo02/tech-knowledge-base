...
class IndustryAnalysis extends React.Component {
  ...
  render () {
    const { cropListByArea, cropListByAreaTotal, cropListByIndustry, cropListByIndustryTotal } = this.props.rankingListDetail;
    ...
    return (
      <div className="rankingListAnalysis">
        ...
        <ConfigProvider renderEmpty={() => renderEmptyData(0, this.$translation)}>
          <Table size="small" rowKey="key" className="whole_width"
