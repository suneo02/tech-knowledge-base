...
export const UserNoteTextEN = (
  <>
    <div className="customer-title">{intl('209659', '用户协议')}</div>
    <div className="user-note-page">
      ...
      <p>
        The Global Enterprise Library User Agreement (hereinafter referred to as "this Agreement") is a contract between
        you and the Company regarding your downloading, installation, registration, login and use (hereinafter
      ...
      access information related to shareholders, legal representatives, enterprises' investment, credit information of
      enterprises. It provides business registration information, credit inquiry services, enterprise litigation,
      ...
      Global Enterprise Library. The agreement includes the usage policy and privacy policy of the content of the Global
      Enterprise Library website and related software products. Before using the various services provided by Global
      Enterprise Library, you should read this Agreement carefully. If you do not agree with this Agreement or any
      changes to it at any time, you can actively cancel the services provided by Global Enterprise Library. If you
      voluntarily choose to agree to or use the Global Enterprise Library and related services, you are deemed to have
      fully understood this Agreement and agree to be bound by this Agreement and other agreements and rules relating to
      the Global Enterprise Library and related services (including but not limited to the Privacy Policy) as a party to
      this Agreement and become a user of Wind Enterprise Library (hereinafter referred to as "user").
      <br />
      ...
      you continue to use the online service, it shall be deemed that you accept the changes to the service terms. Wind
      Credit reserves the right to modify or interrupt the service. Wind Credit shall not be liable to users or third
      parties for any loss caused by any modification, interruption, or termination of any network service.
      <br />
      <h2>2. Obligations</h2>
      ...
      <br />
      Upon completion of the registration process for the Global Enterprise Library service, you will get a password and
      account. It is your responsibility to maintain the confidentiality and security of your password and account. You
      agree to be fully responsible for all activities that occur under your password or account. You agree:
      <br />
      ...
      <br />
      A single account can log in to only one device of the same type at a time (for example, the same account can only
      log in to one computer at a time, but you can also log in to your mobile phone). Otherwise, you will be forced to
      log out, and we will not be liable for any damages. Users are not allowed to have continuous and frequent query
      operations. Otherwise, we will automatically block your account without any liability to you. You should log out
      and close their accounts when you have finished using them. If you fail to comply with the above requirements, you
      will be fully responsible for any actions taken by anyone using your password and account, and Wind Credit will
      not be liable for any losses or damages;
      <br />
      ...
      software products, including introducing the various functions of this service to new users through email, mobile
      phone, and APP message. You will receive emails, short messages, and APP message from Wind Credit related to your
      account, including notifications issued by other users in your personal network. Wind Credit may send you
      promotional information, unless you choose not to receive similar information.
      <br />
      ...
      content you share or publish may be viewed by other "members" and, if it is public information, may also be viewed
      by "visitors." You can set up the above information and content, and we respect your choice of who can view your
      personal content or information. We are not obligated to publish all the relevant information or content about
      your use of the Global Enterprise Library service, but we may delete information or content at our discretion in
      accordance with laws and regulations or in reasonable circumstances without sending a notice.
      <br />
      ...
      telecommunications departments, temporary shutdown of the website due to government control, etc.) and other force
      majeure events, as well as deliberate destruction by others, negligence or improper use by staff, normal system
      maintenance, system upgrades, or network congestion that causes this website to be inaccessible and results in any
      losses suffered by users. <br />
      (2) When using the "Services", you may encounter inaccurate, incomplete, outdated, misleading, illegal, offensive,
      or harmful content or information. It is difficult for Wind Credit to review each user's content or information to
      determine whether it falls into the above categories. Our platform only responds to user-submitted query requests
      for identification and does not verify the authenticity of the identified content or information. The platform
      does not have an obligation to verify the accuracy of the identified results themselves. The data results returned
      by the platform do not constitute any express or implied opinions or guarantees by us. Please refer to the
      official website for the accurate results. Therefore, you agree that we are not responsible for the content or
      information provided by third parties (including other users) and are not responsible for any losses you may
      suffer due to the use or reference of such content or information. If you believe that there is such content or
      information, please notify Wind Credit in accordance with the procedures prescribed by laws and regulations so
      that prompt processing can be carried out. <br />
      (3) Wind Credit may ask for personal information in accordance with legal requirements or relevant policies of the
      government. <br />
      ...
      (5) Wind Credit lists the usage methods and exemption clauses in the various service terms and statements. (6) All
      content uploaded by customers (including company profiles, jobs, reviews, financial data, and other data, etc.)
      are created by users and serve as a platform for users to introduce and comment on the things and phenomena
      referred to by the company name. The content uploaded by customers only represents the author's views and is not
      related to Wind Credit. Except as otherwise provided by law, all liabilities arising from the authenticity of user
      comments shall be borne by the users themselves, and Wind Credit shall not bear any responsibility. <br />
      ...
      the permission of the Company, or automatically obtain data from the Global Enterprise Library through any robot,
      "spider" or other programs. Otherwise, Wind Credit will investigate and pursue legal responsibilities.
      <h2>5.Service Termination</h2>
      Users or Wind Credit may interrupt the service according to the actual situation. Wind Credit does not need to be
      responsible to any individual or third party for interrupting the service. If users object to any proposed changes
      to the service terms or have objections to later terms, or are dissatisfied with the Wind Credit service, users
      ...
      (3) The service price of shall be based on the detailed fee schedule displayed on the website and related software
      products. Global Enterprise Library has the right to modify prices, upgrade services, add or reduce service
      content for its members. The standard of value-added services for VIP members shall be based on the detailed fee
      schedule displayed by Global Enterprise Library. You can log in to the Global Enterprise Library user center to
      check your account information details. <br />
      ...
      Global Enterprise Library completes the activation of the VIP membership service through the system, you become a
      VIP member of Global Enterprise Library. The VIP membership service of Global Enterprise Library is effective
      ...
      by third parties. <br />
      (4) The ownership of the VIP membership account of the Global Enterprise Library belongs to the Global Enterprise
      Library. VIP members only have the limited right to use the account. <br />
      (5) The content and fees of the membership services are based on the rights and fee schedule displayed in the
      Global Enterprise Library. Global Enterprise Library has the right to modify or improve the existing services and
      fee schedule based on legal and regulatory requirements, business strategies, and other reasons. Once the
      ...
      have accepted its service period. The VIP membership service is only for the account holder's personal use; during
      the VIP membership service period, it cannot be transferred between accounts in the Global Enterprise Library, and
      is prohibited from being donated, lent, transferred, or sold. Otherwise, Global Enterprise Library has the right
      to cancel the VIP membership service qualifications of the transferred accounts and the acquiring accounts without
      notice, and the resulting losses shall be borne by the VIP members themselves. <br />
      ...
      <div>
        ...
        <HKInfoQueryAggreBtn title={'Enterprise Information Inquiry Authorization Agreement'} />. This User Agreement,
        together with the aforementioned Authorization Agreement, the{' '}
        <Links
          className={styles.userNoteLink}
          module={LinksModule.USER}
          subModule={UserLinkEnum.UserPolicy}
          title="Global Enterprise Library Privacy Policy"
        />
        , the{' '}
        <Links
          className={styles.userNoteLink}
          title="Global Enterprise Library Disclaimer"
          module={LinksModule.USER}
          subModule={UserLinkEnum.Exceptions}
        />
        , other agreements/instructions related to this product, and the Platform Terms and Conditions(including any
        amended versions of the aforementioned agreements, disclaimers, policies, and other instructions from time to
        time), shall be inseparable from and shall have the same legal effect as the main text of this User Agreement.
      </div>
      ...
      8.2.1 The information you produce, comment on, upload, publish and disseminate shall consciously comply with laws
      and regulations, abide by public order, respect social morality, socialist system, national interests, legitimate
      rights and interests of citizens, social public order, morality and authenticity of information and other "seven
      bottom line" requirements, otherwise the company has the right to immediately take appropriate The company has the
      right to take appropriate measures immediately. You agree and promise not to produce, copy, publish or disseminate
      ...
      (16) Dissemination of commercial advertising, or similar commercial solicitation information, excessive marketing
      information and spam. <br />
      ...
      (19) Where the published information is meaningless or where the combination of characters is deliberately used to
      avoid technical review. <br />
      (20) Without the permission of others, secretly filming, secretly recording others, infringing on the legal rights
      of others. <br />
      ...
      ii. Any content that threatens life and health, endangers one's own or others' personal and/or property rights by
      performing with dangerous instruments such as knives. <br />
      ...
      (22) Other information that violates laws, regulations, policies and public order and morals, interferes with the
      normal operation of "Wind Financial Terminal" or violates the legitimate rights and interests of other users or
      third parties. <br />
      ...
      (6) Unauthorized attempts to probe, scan, test the vulnerability of the Wind Financial Terminal system or network
      or other acts that undermine network security. <br />
      ...
      (9) reverse engineering, disassembling, compiling or otherwise attempting to discover the source code of the Wind
      Financial Terminal software and related services. <br />
      (10) Maliciously registering accounts for the Wind Financial Terminal software and related services, including but
      not limited to frequent and bulk account registration. <br />
      (11) Violation of laws and regulations, this Agreement, the Company's relevant rules and other acts that infringe
      on the legitimate rights and interests of others. <br />
      ...
      (4) Without the consent of the Global Enterprise Library, sending emails, making phone calls, sending letters, or
      otherwise contacting individuals or companies that publish information. <br />
      8.2.5 If the Company has reason to believe that your behavior violates or may violate the above agreement, the
      Company may independently judge and deal with it, and has the right to terminate the provision of services to you
      without prior notice and pursue relevant legal responsibilities. <br />
      <h2>9.Source statement</h2>
      The Global Enterprise Library, a big data software developed and operated by Wind Credit, is a corporate business
      data and other public information inquiry system (referred to as "Global Enterprise Library"). According to user
      instructions, the search engine system of the Global Enterprise Library will automatically generate the user's
      search for legally disclosed corporate information in an non-manual search manner, so that users can find and use
      ...
      (1) Publicity basis
      <br />
      The information publicity of this system is based on the relevant provisions of laws, regulations, and rules such
      as the "Regulation on the Openness of Government Information" and the "Interim Measures for the Disclosure of
      Enterprise Information". According to the "Interim Measures for the Disclosure of Enterprise Information (State
      Council Decree No. 654)" implemented on October 1, 2014, the relevant provisions are as follows:
      <br />
      "Article 6: The industrial and commercial administrative departments shall, through the enterprise credit
      information publicity system, disclose the following enterprise information generated in the process of performing
      their duties:
      <br />
      ...
      <br />
      (5) Other information that should be disclosed in accordance with the law. The enterprise information referred to
      in the preceding paragraph shall be disclosed within 20 working days from the date of its generation."
      <br />
      "Article 7: Other government departments (hereinafter referred to as other government departments) shall disclose
      the following enterprise information generated in the process of performing their duties:
      <br />
      ...
      and other government departments shall, in accordance with the overall requirements of the national social credit
      information platform construction, achieve the interconnection and sharing of enterprise information."
      <br />
      ...
      <br />
      (7) Information on the number of employees, total assets, total liabilities, external guarantee liabilities, total
      owner's equity, total operating income, main business income, profit, net profit, and total tax payment. The
      information specified in the first to sixth items shall be publicly disclosed, and the information specified in
      the seventh item shall be chosen by the enterprise whether to be publicly disclosed. With the consent of the
      ...
      <br />
      "Article 10: Enterprises shall, within 20 working days from the date the following information is formed, disclose
      it to the public through the enterprise credit information publicity system:
      <br />
      ...
      disclosure obligation in accordance with the provisions of the preceding paragraph, it shall order the enterprise
      to perform the obligation within a time limit."
      <br />
      (2) The information disclosed in this system comes from the industrial and commercial administrative departments,
      other government departments, and market entities. The government departments and market entities are responsible
      for the authenticity of the information they disclose.
      <br />
      ...
      can be inferred that the information disclosed on this website is public information and does not constitute trade
      ...
      "Article 2: China Judgment Document Network is the unified platform for all courts to publish judgment documents.
      Courts at all levels shall set up links to China Judgment Document Network on their official websites and judicial
      open platforms."
      <br />
      ...
      execution and change decisions; (8) For the disturbance of litigation and execution, the decision of detention and
      fine, the decision of early release from detention, and the decision of appeal for review of the detention and
      fine and other sanctions; (9) Administrative mediation and civil public interest litigation mediation; (10) Other
      judgment documents that have a suspending or terminating effect on the litigation process or have an impact on the
      parties' substantive rights and interests or significantly affect the parties' procedural rights and interests."
      <br />
      "Article 4: Judgment documents of the people's courts that meet any of the following circumstances shall not be
      published on the Internet: (1) Involving state secrets; (2) Involving juvenile crimes; (3) Settled by mediation or
      confirmed the effectiveness of people's mediation agreements, but it is necessary to publicly disclose for the
      protection of national interests, social public interests, or the rights and interests of others; (4) Divorce
      lawsuits or involving the custody and upbringing of minors; (5) Other circumstances in which the people's court
      believes it is inappropriate to publish on the Internet."
      <br />
      In summary, the content disclosed on China Judgment Document Network is legally public content and does not exist
      any inapplicability for public disclosure.
      <br />
      ...
      <br />
      (1) Publicity basis: According to the "Provisions of the Supreme People's Court on the Publication of the List of
      Defaulters in Execution Proceedings" implemented on October 1, 2013 (Fa Shi [2013] No. 17), the relevant
      ...
      and performance of the defendant as stipulated in the effective legal instruments; (4) The specific circumstances
      of the defendant's defaulter behavior; (5) The production unit and number of the legal instrument, execution case
      number, date of filing, and execution court; (6) Other matters that the people's court believes should be recorded
      and published, which do not involve state secrets, business secrets, or personal privacy." (2) According to the
      "Use Declaration of National Court Execution Information Query": "In order to promote the construction of social
      credit system, effectively solve the problem of execution difficulty, promote the automatic performance of the
      obligations of the execution by the defendants, ensure the citizens, legal persons, and other organizations to
      obtain the information of the execution cases, give full play to the service role of the execution case
      information in people's daily life, production, and social economic activities, and refer to the 'Regulation on
      the Openness of Government Information of the People's Republic of China', the Supreme People's Court has opened
      the 'National Court Execution Information Query' platform to the public since March 30, 2009. The public can query
      the information of the defendants in the execution cases of all courts (excluding military courts) that were newly
      received and not yet concluded since January 1, 2007, and before that. Regarding the following matters, the
      declaration is as follows:
      <br />
      "(1) The information of the execution defaulters is entered and verified by the execution court. If the relevant
      parties have objections to the content of the information, they can apply for correction to the execution court in
      writing according to the "Provisions of the Supreme People's Court on the Handling of Information Dispute Cases in
      the National Court Execution Information Query Platform".
      <br />
      (2) The information provided on this website is for reference only for the query person. If there is any dispute,
      the relevant legal documents of the execution court shall prevail. The people's court will not bear any
      ...
      purposes or inappropriate purposes. If the illegal use of the information on this website causes damage to others,
      the person responsible for the use shall bear the corresponding responsibility.
      <br />
      ...
      People's Republic of China" which came into effect on October 1, 2009: "Article 21 The State Intellectual Property
      Office and the Patent Re-examination Board shall, in accordance with the requirements of objectivity,
      ...
      <br />
      "Article 28 For trademark applications, the Trademark Office shall, within nine months from the date of receipt of
      the application for trademark registration, review and decide whether to preliminarily approve the application. If
      it meets the relevant provisions of this Law, it shall be preliminarily approved and announced." "Article 35 If an
      objection is made to a preliminarily approved trademark, the Trademark Office shall hear the facts and reasons of
      the objector and the respondent, and, after investigation and verification, make a decision within twelve months
      from the date of the announcement, whether to allow the registration, and shall notify the objector and the
      respondent in writing. If there are special circumstances that require an extension, with the approval of the
      State Administration for Industry and Commerce of the People's Republic of China, it may be extended for six
      months. If the Trademark Office decides to allow the registration, it shall issue the trademark registration
      certificate and announce it."
      <br />
      "Article 40 If the registered trademark expires and needs to be continued, the trademark registrant shall, within
      twelve months before the expiration, handle the renewal procedures in accordance with the provisions. During this
      period, if it is not handled, a six-month grace period may be granted. The effective period of each renewal
      registration is ten years, calculated from the next day after the expiration of the previous registration period.
      If the renewal procedures are not completed within the expiration, the registered trademark shall be canceled. The
      Trademark Office shall announce the renewal registration of the trademark." "Article 42 In the case of
      transferring a registered trademark, the transferor and the transferee shall sign a transfer agreement and jointly
      apply to the Trademark Office. The transferee shall guarantee the quality of the goods in which the registered
      trademark is used. When transferring a registered trademark, the trademark registrant shall transfer any similar
      trademarks registered for the same or similar goods. The Trademark Office shall not approve the transfer if it is
      likely to cause confusion or has other adverse effects, and shall notify the applicant in writing, stating the
      reasons. After the transfer of the registered trademark is approved, it shall be announced. The transferee shall
      enjoy the exclusive right to use the trademark from the date of announcement."
      <br />
      ...
      used. The licensee shall guarantee the quality of the goods in which the registered trademark is used. In the case
      of using another's registered trademark with permission, the name of the licensee and the place of origin of the
      goods must be indicated on the goods. The licensor shall report the trademark use license to the Trademark Office
      for record, and the Trademark Office shall announce it. A trademark use license that has not been filed for
      recordation shall not be effective against a bona fide third party."
      <br />
      "Article 47 In accordance with Article 44 and Article 45 of this Law, the registration trademark declared invalid
      shall be announced by the Trademark Office, and the exclusive right to use the registered trademark shall be
      deemed not to exist from the beginning."
      <br />
      "Article 55 If the parties do not apply for review of the Trademark Office's decision to cancel the registered
      trademark or do not appeal to the people's court for the review decision of the Trademark Review and Adjudication
      Committee within the statutory time limit, the decision to cancel the registered trademark and the review decision
      shall take effect. The registered trademark that has been cancelled shall be announced by the Trademark Office,
      and the exclusive right to use the registered trademark shall expire from the date of announcement."
      <br />
      ...
      regulations or norms, users and users' related system personnel should obtain the necessary authorization from the
      relevant rights holders before conducting data queries and usage. If users or users' related system personnel
      access or use information without obtaining the necessary authorization from the relevant rights holders, they
      shall bear all the adverse consequences caused by such access or use.
      <br />
      <h2>10.User Privacy</h2>
      Global Enterprise Library absolutely respects the personal privacy rights of users. Global Enterprise Library will
      not publicly, edit, or disclose any user's information to third parties unless there is a legal and
      ...
      laws of the People's Republic of China. You agree that any disputes arising from the agreement and the use of the
      Global Enterprise Library shall be submitted to the local court of Shanghai Wind Credit Service Co., Ltd. for
      ...
      attention to them at any time. Your continued use of the Global Enterprise Library and related services after the
      modification of this agreement shall be deemed to have agreed and accepted the modification of this agreement.
