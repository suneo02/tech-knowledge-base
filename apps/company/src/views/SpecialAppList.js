    ...
    <React.Fragment>
      <div className="special-app-list">
        ...
        <div className="special-list-wrap">
          <SpecialAppNav config={SpecialAppListConfig} navClickHandle={navClickHandle} />
          ...
          <div className="content-special-list">
            ...
            <SpecialAppFilterTab onFiltersHandle={onFiltersHandle} filtersData={tableData?.filters} />
                ...
                <TableNew
                  ...
                  footerLeftRender={
                    <div className="page-tip">
                      ...
                      <span onClick={gotoBrowser}>{intl('259750')}</span>
                      {intl('437893', '功能')}
                    </div>
                  }
                  maxTotal={40}
