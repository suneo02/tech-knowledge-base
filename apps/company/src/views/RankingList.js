                  ...
                  <Card
                    ...
                    title={
                      <p>
                        ...
                        <MyIcon onClick={this.props.deleteAllSearchHistory} title={this.$translation(149222)} name="Delete_666" />
                      </p>
                    }
                  >
                    <List
                      ...
                      renderItem={(item, index) => (
                        <p onClick={() => this.toDetail(item, 1)} key={index}>
                ...
                {inputValue && inputSearchRes.length > 0 && inputFocusState && (
                  <div className="searchComplete">
                    <List
                      ...
                      renderItem={(item, index) => (
                        <p onClick={() => this.toDetail({ id: item.directoryId, name: item.directoryName }, 1)} key={index}>
