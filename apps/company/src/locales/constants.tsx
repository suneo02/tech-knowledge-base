...
export const SpecialAppListConfig = {
    ...
    columns: [
      {
        ...
        render: function (_txt, data) {
          if (data['ipo'] && data['ipo'].length) {
            ...
            return is_terminal ? <a href={href}>{ipos[0].securityChineseName}</a> : ipos[0].securityChineseName
          }
          return '--'
        },
      },
      {
        ...
        render: function (_txt, data) {
          if (data['ipo'] && data['ipo'].length) {
            const ipos = data['ipo'] || {}
            const href = '!Page[Minute,' + ipos[0].windCode + ']'
            return is_terminal ? <a href={href}>{ipos[0].tradeCode}</a> : ipos[0].tradeCode
          }
          return '--'
        },
      },
  ...
  cngroup: {
    ...
    columns: [
      ...
      { titleId: '419998', align: 'left', width: '30%', dataIndex: 'establishedTime|formatTime' },
    ],
    noExtra: true, // url不需要拼接id
    defaultParams: {
      route: 'cngroup',
  ...
  financialcorp: {
    ...
    columns: [
      ...
      { titleId: '419998', align: 'left', width: '12%', dataIndex: 'establishedTime|formatTime' },
    ],
    defaultParams: {
      route: 'financialcorp',
      corpNature: '银行',
  ...
  pevcinvest: {
    ...
    columns: [
      ...
      { titleId: '419998', align: 'left', width: '13%', dataIndex: 'establishedTime|formatTime' },
    ],
    defaultParams: {
      corpNature: 'invest',
    },
